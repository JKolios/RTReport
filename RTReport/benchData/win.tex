...
\begingroup
  ...
  \begin{picture}(10080.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(1078,2542){\makebox(0,0)[r]{\strut{} 4000}}%
      ...
      \put(4094,4709){\makebox(0,0){\strut{}Χρόνος Επεξεργασίας (Windows)}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{benchData/bench_output_500000_100_10_Js1Win}}%
    \gplfronttext
  \end{picture}%
\endgroup
